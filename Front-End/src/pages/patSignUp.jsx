...
function DocSignUp() {
  ...
  async function handleSubmit(e){
    ...
    let result = await fetch("http://localhost:8000/patient", {
      method:'post',
      body:JSON.stringify({name,username,phoneno,email,password,dob,address,address2,city,state,zip}),
      headers:{
  ...
  return (
    <div>
      <h1 className='title'>Patient Sign-up</h1>
